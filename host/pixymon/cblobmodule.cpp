...
CBlobModule::CBlobModule(Interpreter *interpreter) : MonModule(interpreter)
{
    ...
    //scriptlet << "runprogArg 8 100";
    m_interpreter->emit actionScriptlet("Create new signature point 2...", scriptlet);
    scriptlet.clear();
    scriptlet << "cam_getFrame 0x21 0 0 320 200";
    scriptlet << "newsigPoint 3";
    //scriptlet << "runprogArg 8 100";
    m_interpreter->emit actionScriptlet("Create new signature point 3...", scriptlet);
    scriptlet.clear();
    scriptlet << "cam_getFrame 0x21 0 0 320 200";
    scriptlet << "newsigPoint 4";
    //scriptlet << "runprogArg 8 100";
    m_interpreter->emit actionScriptlet("Create new signature point 4...", scriptlet);
    scriptlet.clear();
    scriptlet << "cam_getFrame 0x21 0 0 320 200";
    scriptlet << "newsigPoint 5";
    //scriptlet << "runprogArg 8 100";
    m_interpreter->emit actionScriptlet("Create new signature point 5...", scriptlet);
    scriptlet.clear();
    scriptlet << "cam_getFrame 0x21 0 0 320 200";
    scriptlet << "newsigPoint 6";
    //scriptlet << "runprogArg 8 100";
    m_interpreter->emit actionScriptlet("Create new signature point 6...", scriptlet);
    scriptlet.clear();
    scriptlet << "cam_getFrame 0x21 0 0 320 200";
    scriptlet << "newsigPoint 7";
    //scriptlet << "runprogArg 8 100";
    m_interpreter->emit actionScriptlet("Create new signature point 7...", scriptlet);
    scriptlet.clear();
    scriptlet << "cam_getFrame 0x21 0 0 320 200";
